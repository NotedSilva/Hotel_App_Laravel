...
<section class="container mt-5">
  ...
  <form class="row g-3" method="post" action="{{route('alterar-funcionario', $registroFuncionarios->id)}}">
    ...
    <div class="col-md-12">
        ...
        <input name="nome" type="text" class="form-control" value="{{old('nome', $registroFuncionarios->nome)}}" id="inputNome" placeholder="Insira seu nome">
        @error('nome')
    ...
    <div class="col-12">
        ...
        <input name="funcao" type="text" class="form-control" value="{{old('funcao', $registroFuncionarios->funcao)}}" id="inputFuncao" placeholder="Insira sua função">
        @error('funcao')
