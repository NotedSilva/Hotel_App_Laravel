  ...
  <form class="row g-3" method="post" action="{{route('alterar-cliente', $registrosClientes->id)}}">
    ...
    @csrf  
        ...
        <div class="col-md-12">
            ...
            <input name="nome" type="text" class="form-control" value="{{old('nome', $registrosClientes->nome)}}" id="inputNome" placeholder="Insira seu nome">
            @error('nome')
        ...
        <div class="col-12">
            ...
            <input name="email" type="email" class="form-control" value="{{old('nome', $registrosClientes->email)}}" id="inputEmail" placeholder="Insira seu email">
            @error('email')
